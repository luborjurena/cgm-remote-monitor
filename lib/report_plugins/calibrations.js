...
calibrations.css =
  '#calibrations-chart .axis{color:#9aa7b3;}' +
  '#calibrations-chart .axis text{fill:#7a8a99;stroke:none;font-size:11px;}' +
  '#calibrations-chart .axis path,#calibrations-chart .axis line{stroke:#dde4ea;shape-rendering:crispEdges;}';
