...
daytoday.css =
  '#daytodaycharts{font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Helvetica,Arial,sans-serif;}' +
  '#daytodaycharts > table{background:#fff;border:1px solid #e6ebf0;border-radius:14px;' +
  '  box-shadow:0 1px 3px rgba(16,32,48,.06);padding:10px 14px;margin:0 0 16px;width:auto;}' +
  '.dtd-title{font-size:14px;font-weight:600;color:#23303d;margin:2px 0 8px;}' +
  '#daytodaycharts .axis{color:#9aa7b3;}' +
  '#daytodaycharts .axis text{fill:#7a8a99;stroke:none;font-size:11px;}' +
  '#daytodaycharts .axis path,#daytodaycharts .axis line{stroke:#dde4ea;shape-rendering:crispEdges;}';
...
daytoday.report = function report_daytoday (datastorage, sorteddaystoshow, options) {
  ...
  function drawChart (day, data, options) {
    ...
    context.append('rect')
      ...
      .style('fill', 'rgba(67,160,71,0.12)')
      .attr('stroke', 'none');
