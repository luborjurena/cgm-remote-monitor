...
function init () {
  ...
  settings.DEFAULT_FEATURES = ['bgnow', 'delta', 'direction', 'timeago', 'devicestatus', 'upbat', 'errorcodes', 'profile', 'bolus', 'dbsize', 'runtimestate', 'basal', 'careportal', 'tir'];
  ...
  function nameFromKey (key, nameType) {
    ...
    return key
      ...
      // Add underscores between letters and trailing numeric suffixes
